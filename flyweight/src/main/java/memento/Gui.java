    ...
    public void start(Stage stage) {
        ...
        historyButton.setOnMouseClicked(event -> {
            ...
            for (IMemento m : controller.getHistory()) {
                int[] options = m.getOptions();
                boolean selected = m.isSelected();

                String text = "Colors: [" + options[0] + ", " + options[1] + ", " + options[2] + "], CheckBox: " + selected;
                Label historyLabel = new Label(text);
